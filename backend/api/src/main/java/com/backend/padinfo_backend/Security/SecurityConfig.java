        ...
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth ->
                        auth.dispatcherTypeMatchers(FORWARD, ERROR).permitAll()
                                ...
                                .requestMatchers(HttpMethod.GET, "/api/tournaments/info/**").hasAnyRole(ERole.ADMIN.name(), ERole.USER.name(), ERole.GUEST.name())
                                .requestMatchers(HttpMethod.GET, "/api/players").hasAnyRole(ERole.ADMIN.name(), ERole.USER.name(), ERole.GUEST.name())
                                .requestMatchers(HttpMethod.GET, "/api/players/info/**").hasAnyRole(ERole.ADMIN.name(), ERole.USER.name(), ERole.GUEST.name())
