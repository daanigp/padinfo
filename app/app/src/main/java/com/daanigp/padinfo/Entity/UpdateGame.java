...
public class UpdateGame {
    ...
    public UpdateGame(String namePlayer1, String namePlayer2, String namePlayer3, String namePlayer4, int set1PointsT1, int set1PointsT2, int set2PointsT1, int set2PointsT2, int set3PointsT1, int set3PointsT2, int winnerTeam) {
